...
A custom Keycloak Docker image designed for CI/CD environments with changed command and realm import on startup.

**🎯 Problem Solved**: Makes Keycloak usable as a service in GitHub Actions.
